							...
							<TBODY>
								...
								<TR>
									<TD>
										<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="user_saveUI.action" 
														target=main>－ 添加用户</A></TD>
												</TR>
												<TR> 
													<TD class=menuSmall><A class=style2 href="user_findAllUsers.action"
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_2');"><SPAN
										class=span id=table_2Span>＋</SPAN> 图书管理</TD>
								</TR>
								<TR>
									<TD>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_3');"><SPAN
										class=span id=table_3Span>＋</SPAN> 订单管理</TD>
								</TR>
								<TR>
									<TD>
