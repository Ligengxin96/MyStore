...
<BODY>
	<FORM id="customerForm" name="customerForm"			
		action="${pageContext.request.contextPath }/linkMan_findAllLinkMans.action"
		method=post>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/linkMan_deleteCustomer.action?lkm_id=<s:property value="lkm_id" />">删除</a>
													</TD>
												</TR>
												</s:iterator>
