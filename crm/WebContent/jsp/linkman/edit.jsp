...
<BODY>
	<s:form id="form1" name="form1" action="linkMan_updateLinkMan" namespace="/" method="post" theme="simple">
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<tr>
								<td>所属客户：</td>
								<td colspan="3">
									<s:select list="customersList" name="customer.cust_id" headerKey="" headerValue="-请选择-" listKey="cust_id" listValue="cust_name"/>
								</td>
							</tr>
							<TR>
								<td>联系人名称：</td>
